...
class DemoApp(AndroidApp):
    ...
    def _start(self, clear_state=True, kill_process=True, start_extra_params={}):
        ...
        self.device.adb.start_activity('%s/%s.kernel.login.activity.SplashActivity' % (self.package_name, self.package_name), extra=start_extra_params)
